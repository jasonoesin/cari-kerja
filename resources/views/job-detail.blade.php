...
@section('content')
    ...
    <div class="">
        ...
        <div  id="modal" class="!MODAL w-full h-[100vh] bg-black/50 fixed inset-0 z-10 flex justify-center flex-col">
                ...
                <div class="relative WHITE-CARD w-[30rem] bg-white rounded h-fit pb-8 opacity-100 py-4 px-8">
                    ...
                    <div class="mt-8  now flex flex-col gap-4">
                        ...
                        <div class="w-full flex flex-col gap-4">
                            ...
                            <button class="bg-[#017eb7] px-16 py-6 font-bold w-full text-white text-[1rem] flex items-center justify-center gap-2" id="btn-file" type="button">
                                APPLY NOW
                            </button>
                        </div>
                    </div>
